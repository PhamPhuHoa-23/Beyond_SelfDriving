...
class LogoGeneration(Scene):
    CONFIG = {'radius': 1.5, 'inner_radius_ratio': 0.55, 'circle_density': 100, 'circle_blue': 'skyblue', 'circle_brown': DARK_BROWN, 'circle_repeats': 5, 'sphere_density': 50, 'sphere_blue': BLUE_D, 'sphere_brown': LIGHT_BROWN, 'interpolation_factor': 0.3, 'frame_duration': 0.03, 'run_time': 3}
    ...
    def construct(self):
        ...
        for mob, color in [(iris, self.sphere_brown), (circle, self.circle_brown)]:
            ...
            mob.set_color('black', lambda point: get_norm(point) < self.inner_radius_ratio * self.radius)
