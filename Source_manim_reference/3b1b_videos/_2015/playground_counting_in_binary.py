...
COUNT_TO_FRAME_NUM = {0: 0, 1: 53, 2: 84, 3: 128, 4: 169, 5: 208, 6: 238, 7: 281, 8: 331, 9: 365, 10: 395, 11: 435, 12: 475, 13: 518, 14: 556, 15: 595, 16: 636, 17: 676, 18: 709, 19: 753, 20: 790, 21: 835, 22: 869, 23: 903, 24: 950, 25: 988, 26: 1027, 27: 1065, 28: 1104, 29: 1145, 30: 1181, 31: 1224, 32: 1239}
...
class EdgeDetection(SceneFromVideo):
    args_list = [('CountingInBinary.m4v', 35, 70), ('CountingInBinary.m4v', 0, 100), ('CountingInBinary.m4v', 10, 50)]
...
class DraggedPixels(SceneFromVideo):
    args_list = [('BufferedCounting',), ('CountingWithLeftClear',)]
    ...
    def drag_pixels(self, num_frames_to_drag_over=5):
        for index in range(len(self.frames) - 1, 0, -1):
            self.frames[index] = np.max([self.frames[k] for k in range(max(index - num_frames_to_drag_over, 0), index)], axis=0)
...
class ShowCounting(SceneFromVideo):
    args_list = [('CountingWithLeftClear',), ('ClearLeftSideBufferedCounting',)]
    ...
    def construct(self, filename):
        ...
        for count in range(32):
            ...
            index_range = list(range(max(COUNT_TO_FRAME_NUM[count] - 10, 0), COUNT_TO_FRAME_NUM[count + 1] - 10))
            for index in index_range:
                self.frames[index] = disp.paint_mobject(mob, self.frames[index])

class ShowFrameNum(SceneFromVideo):
    args_list = [('ClearLeftSideBufferedCounting',)]
