...
class AnimatedMidi(Scene):
    ...
    dist_per_sec = 4.0
    bpm = 240
    CONFIG = {'camera_config': {'anti_alias_width': 0, 'samples': 4}}
    hit_depth = 0.025
    note_color = BLUE
    hit_color = TEAL
    ...
    def add_note_rects(self):
        ...
        tempo = 250000
        sec_per_tick = tempo * 1e-06 / mid.ticks_per_beat
        ...
        for msg in track:
            ...
            if msg.type == 'note_on' and msg.velocity > 0:
                ...
                rect = Rectangle(width=self.note_to_key_width_ratio * key.get_width(), height=(time_in_ticks - start_time_in_ticks) * dist_per_tick)
