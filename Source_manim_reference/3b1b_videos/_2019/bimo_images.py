...
class PrimePiEPttern(Scene):
    ...
    def construct(self):
        ...
        self.add(tex1)
        return
        tex2 = OldTex('\\frac{1}{2^2}', '+', '\\frac{1}{3^2}', '+', '\\frac{1}{2}', '\\cdot', '\\frac{1}{4^2}', '+', '\\frac{1}{5^2}', '+', '\\frac{1}{7^2}', '+', '\\frac{1}{3}', '\\cdot', '\\frac{1}{8^2}', '+', '\\frac{1}{2}', '\\cdot', '\\frac{1}{9^2}', '+', '\\frac{1}{11^2}', '+', '\\frac{1}{13^2}', '+', '\\frac{1}{4}', '\\cdot', '\\frac{1}{16^2}', '+', '\\cdots')
        self.alter_tex(tex2)
        VGroup(tex2[2 * 0], tex2[2 * 1], tex2[2 * 4], tex2[2 * 5], tex2[2 * 10], tex2[2 * 11]).set_color(GREEN_E)
        VGroup(tex2[2 * 2], tex2[2 * 3], tex2[2 * 6], tex2[2 * 7], tex2[2 * 8], tex2[2 * 9], tex2[2 * 12], tex2[2 * 13]).set_color(BLUE_D)
        self.add(tex2)
