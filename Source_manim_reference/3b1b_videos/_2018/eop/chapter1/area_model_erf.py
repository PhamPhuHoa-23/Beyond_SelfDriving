...
class IllustrateAreaModelErf(GraphScene):
    CONFIG = {'x_min': -3.0, 'x_max': 3.0, 'y_min': 0, 'y_max': 1.0, 'num_rects': 400, 'y_axis_label': '', 'x_axis_label': '', 'variable_point_label': 'a', 'graph_origin': 2.5 * DOWN + 4 * RIGHT, 'x_axis_width': 5, 'y_axis_height': 5}
    ...
    def construct(self):
        ...
        self.remove(self.left_T_label_group[0], self.right_T_label_group[0])
