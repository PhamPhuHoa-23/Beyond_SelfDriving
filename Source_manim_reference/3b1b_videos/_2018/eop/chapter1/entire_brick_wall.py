...
class EntireBrickWall(BrickRowScene, MovingCameraScene):
    ...
    def construct(self):
        ...
        mobs_to_shift = VGroup(rows, flip_counters, tails_counters, nb_tails_text)
        ...
        self.wait()
        self.play(FadeOut(highlighted_bricks[10]), FadeIn(highlighted_bricks[9]), FadeIn(highlighted_bricks[11]))
        self.wait()
        self.play(FadeOut(highlighted_bricks[9]), FadeOut(highlighted_bricks[11]), FadeIn(highlighted_bricks[8]), FadeIn(highlighted_bricks[12]))
        self.wait()
        self.play(FadeOut(highlighted_bricks[8]), FadeOut(highlighted_bricks[12]), FadeOut(last_row_rect), rows.restore)
        self.wait()
