...
class IllustrateAreaModelExpectation(Scene):
    ...
    def construct(self):
        ...
        hist = Histogram(probabilities, y_values, mode='widths', x_scale=x_scale, y_scale=y_scale, x_labels='none')
        flat_hist = Histogram(probabilities, 0 * y_values, mode='widths', x_scale=x_scale, y_scale=y_scale, x_labels='none')
        ...
        averaged_hist = flat_hist = Histogram(probabilities, averaged_y_values, mode='widths', x_scale=x_scale, y_scale=y_scale, x_labels='none', y_labels='none').fade(0.2)
        ...
        self.play(FadeIn(average_group), Transform(braces, one_brace), Transform(p_labels, one_p_label))
