...
class RandyIsSickOrNot(Scene):
    ...
    def construct(self):
        ...
        self.add(p_sick)
        self.wait()
        self.play(ApplyMethod(randy.get_slightly_sick, rate_func=there_and_back))
...
class OneIn200HasDisease(Scene):
    ...
    def construct(self):
        ...
        title.to_edge(UP)
        creature = PiCreature()
        all_creatures = VGroup(*[VGroup(*[creature.copy() for y in range(20)]).arrange(DOWN, SMALL_BUFF) for x in range(10)]).arrange(RIGHT, SMALL_BUFF)
