...
class WhatDoesItReallyMean(TeacherStudentsScene):
    ...
    def construct(self):
        ...
        self.play(student_bubble.scale, 0.5, student_bubble.to_corner, UL)
        self.teacher_says("Don't worry -- philosophy\\\\ can come later!", added_anims=[self.change_students(*3 * ['happy'])])
        self.wait(2)
