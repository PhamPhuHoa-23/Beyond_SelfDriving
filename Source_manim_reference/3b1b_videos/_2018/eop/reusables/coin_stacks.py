...
class CoinStack(VGroup):
    CONFIG = {'coin_thickness': COIN_THICKNESS, 'size': 5, 'face': FlatCoin}
...
class TallyStack(VGroup):
    ...
    def init_points(self):
        ...
        self.background_rect = background_rect = RoundedRectangle(width=TALLY_BACKGROUND_WIDTH, height=TALLY_BACKGROUND_WIDTH, corner_radius=0.1, fill_color=TALLY_BACKGROUND_COLOR, fill_opacity=1.0, stroke_width=3).align_to(self.anchor, DOWN).shift(0.1 * DOWN)
