...
class Histogram(VMobject):
    CONFIG = {'start_color': RED, 'end_color': BLUE, 'x_scale': 1.0, 'y_scale': 1.0, 'x_labels': 'auto', 'y_labels': 'auto', 'y_label_position': 'top', 'x_min': 0, 'bar_stroke_width': 5, 'outline_stroke_width': 0, 'stroke_color': WHITE}
