...
class RearrangeEquation(Scene):
    ...
    def construct(self, start_terms, end_terms, index_map, path_arc=np.pi, start_transform=None, end_transform=None, leave_start_terms=False, transform_kwargs={}):
        ...
        mobject_pairs = [(start_mobs[a], end_mobs[b]) for a, b in index_map.items()] + [(Point(end_mobs[b].get_center()), end_mobs[b]) for b in unmatched_end_indices]
