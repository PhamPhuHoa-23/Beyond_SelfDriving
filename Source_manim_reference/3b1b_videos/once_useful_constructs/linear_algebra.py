...
def vector_coordinate_label(vector_mob: VMobject, integer_labels: bool=True, n_dim: int=2, color: ManimColor=WHITE) -> Matrix:
...
def get_det_text(matrix: Matrix, determinant: int | str | None=None, background_rect: bool=False, initial_scale_factor: int=2) -> VGroup:
    parens = Tex('()')
