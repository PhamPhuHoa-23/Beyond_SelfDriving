...
class DiamondFractalCreation(FractalCreation):
    CONFIG = {'fractal_class': DiamondFractal, 'max_order': 6, 'fractal_kwargs': {'height': 6}}

class PiCreatureFractalCreation(FractalCreation):
    CONFIG = {'fractal_class': PiCreatureFractal, 'max_order': 6, 'fractal_kwargs': {'height': 6}, 'transform_kwargs': {'lag_ratio': 0, 'run_time': 2}}
...
class QuadraticKochFractalCreation(FractalCreation):
    CONFIG = {'fractal_class': QuadraticKoch, 'max_order': 5, 'fractal_kwargs': {'radius': 10}}

class KochSnowFlakeFractalCreation(FractalCreation):
    CONFIG = {'fractal_class': KochSnowFlake, 'max_order': 6, 'fractal_kwargs': {'radius': 6, 'num_submobjects': 100}, 'transform_kwargs': {'lag_ratio': 0.5, 'path_arc': np.pi / 6, 'run_time': 2}}

class WonkyHexagonFractalCreation(FractalCreation):
    CONFIG = {'fractal_class': WonkyHexagonFractal, 'max_order': 5, 'fractal_kwargs': {'height': 6}}

class SierpinskiFractalCreation(FractalCreation):
    CONFIG = {'fractal_class': Sierpinski, 'max_order': 6, 'fractal_kwargs': {'height': 6}, 'transform_kwargs': {'path_arc': 0}}

class CircularFractalCreation(FractalCreation):
    CONFIG = {'fractal_class': CircularFractal, 'max_order': 5, 'fractal_kwargs': {'height': 6}}