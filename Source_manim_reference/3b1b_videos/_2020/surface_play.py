...
class EarthMorph(Scene):
    ...
    def construct(self):
        ...
        earths = [TexturedSurface(surface, 'EarthTextureMap', 'NightEarthTextureMap') for surface in [sphere, torus1, torus2]]
        for mob in earths:
        ...
        self.play(Transform(earth, earths[2]), frame.increment_phi, -10 * DEGREES, frame.increment_theta, -20 * DEGREES, run_time=3)
