...
class MeasuringNearbyStars(InteractiveScene):
    ...
    def construct(self):
        ...
        self.play(stars.animate.set_opacity(opacities), ShowCreationThenFadeOut(ms_circle), FadeIn(ms_label), example_star.animate.move_to(axes.c2p(0.1, 0.5)), run_time=2)
        self.play(GrowArrow(ms_arrow))
        self.wait()
        opacities[in_ms] = 0.025
        self.play(stars.animate.set_opacity(opacities).set_anim_args(run_time=1))
        self.wait(6)
        self.play(example_star.animate.move_to(axes.c2p(0.5, 0.2)).set_anim_args(run_time=15))
        self.wait()
