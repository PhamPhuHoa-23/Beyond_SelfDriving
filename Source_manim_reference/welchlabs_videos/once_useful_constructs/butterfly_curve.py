...
class RotatingButterflyCurve(Animation):
    CONFIG = {'space_epsilon': 0.002, 'grid_line_sep': 0.2, 'radius': 2, 'radians': 2 * np.pi, 'run_time': 15, 'rate_func': linear}
    ...
    def __init__(self, **kwargs):
        ...
        self.points = np.array([[x, y, x * x, y * y] for a in fine_range for b in corse_range for x, y in [(a, b), (b, a)]])
