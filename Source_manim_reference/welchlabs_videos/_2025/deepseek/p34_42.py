...
class p34_42d(InteractiveScene):
    ...
    def construct(self):
        ...
        full_mla_3d_layers = Group(*[mla_heads[i][0][2:] for i in range(11, 0, -1)] + [mla_heads[i][1][6] for i in range(11, 0, -1)] + [mla_heads[i][1][7] for i in range(11, 0, -1)] + [mla_heads[i][0][0] for i in range(11, 0, -1)])
        ...
        self.wait()
        self.play(full_mla_3d_layers.animate.set_opacity(0.85), FadeOut(to_fade_out_2d), mla_heads[0][0][1].animate.move_to([-0.5, 1.35, 0]), mla_heads[0][1][3].animate.move_to([-0.5, 1.35, -0.2]), self.frame.animate.reorient(-38, 72, 0, (0.08, 0.71, 0.08), 2.62), run_time=3)
        ...
        self.wait()
        self.play(self.frame.animate.reorient(0, 89, 0, (-0.12, 0.78, 0.1), 2.48), run_time=10, rate_func=linear)
        self.wait()
        self.wait(20)
        self.embed()
