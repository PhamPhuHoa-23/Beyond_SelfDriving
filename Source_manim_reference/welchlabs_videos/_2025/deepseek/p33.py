...
class p33(InteractiveScene):
    ...
    def construct(self):
        ...
        self.wait()
        self.play(*[self.frame.animate.reorient(-51, 66, 0, (-0.37, 0.6, -0.12), 2.37)] + [attention_heads[i][0][0].animate.set_opacity(0.0) for i in range(12)] + [attention_heads[0][1][3].animate.set_opacity(0.0)] + [attention_heads[i][0][1].animate.move_to([-0.53, 0.39, -0.1]) for i in range(4)] + [attention_heads[i][0][1].animate.move_to([-0.53, 1.391, -0.1]) for i in range(4, 8)] + [attention_heads[i][0][1].animate.move_to([-0.53, 2.38, -0.1]) for i in range(8, 12)] + [attention_heads[0][1][4].animate.move_to([-0.53, 0.38, -0.26])] + [attention_heads[i][0][2].animate.move_to([-0.53, 0.39, -0.5]) for i in range(4)] + [attention_heads[i][0][2].animate.move_to([-0.53, 1.38, -0.5]) for i in range(4, 8)] + [attention_heads[i][0][2].animate.move_to([-0.53, 2.39, -0.5]) for i in range(8, 12)] + [attention_heads[0][1][5].animate.move_to([-0.53, 0.38, -0.66])], run_time=5)
        self.wait()
        ...
        connector_1.move_to([0.18, 1.39, -0.11])
        connector_1b = connector_1.copy()
        connector_1b.move_to([0.18, 2.39, -0.11])
        ...
        self.play(FadeIn(connector_1b), FadeIn(connector_1), FadeIn(white_arrows), FadeIn(connector_1c), FadeIn(connector_2), FadeIn(connector_2b), FadeIn(connector_2c), self.frame.animate.reorient(-38, 59, 0, (0.05, 0.56, 0.06), 2.54), run_time=2)
        self.add(attention_heads[4][0][1])
        self.add(attention_heads[4][0][2])
