...
class p23_28(InteractiveScene):
    ...
    def construct(self):
        ...
        i = 0
        a = get_attention_head(svg_path=svg_path, svg_file='mha_2d_segments-', img_path=img_path / 'gpt_2_attention_viz_5' / str(i))
        x = get_input_x(svg_path='/Users/stephen/welch_labs/deepseek/graphics/to_manim', svg_file='mha_2d_grouping_test.svg', img_path=img_path / 'gpt_2_attention_viz_5')
        ...
        a[0][3:].set_opacity(0.2)
        a[1][7:14].set_opacity(0.2)
        i = 0
        a2 = get_attention_head(svg_path=svg_path, svg_file='mha_2d_segments_10_input-', img_path=img_path / 'gpt_2_attention_viz_5' / str(i))
        self.wait()
        self.play(a[1][1][:-12].animate.scale([1, 0.9, 1]).shift(0.025 * UP), x[0].animate.scale([1, 0.9, 1]).shift(0.025 * UP))
        blue_word = a2[1][1][-20:-16].scale([1, 0.9, 1])
        self.add(blue_word.shift(0.005 * UP))
        self.wait()
        ...
        v1n.set_opacity(0.2)
        self.add(a2[0][5].set_opacity(0.2))
        self.add(a2[0][6].set_opacity(0.2))
        self.play(FadeIn(a2[0][4]), FadeIn(a2[1][8:13]), FadeOut(a[1][8:13]))
        self.remove(a[0][4])
        self.wait()
        self.play(self.frame.animate.reorient(0, 0, 0, (0.42, 0.2, 0.0), 1.32), a2[0][5].animate.set_opacity(1.0), a2[1][9:11].animate.set_opacity(1.0), run_time=2.0)
        self.wait()
        self.play(self.frame.animate.reorient(0, 0, 0, (0.31, -0.02, 0.0), 1.49), a[0][2].animate.set_opacity(1.0), v1n.animate.set_opacity(1.0), a2[0][-1].animate.set_opacity(1.0), a2[1][11:13].animate.set_opacity(1.0), run_time=2.0)
        self.wait()
...
class p29(InteractiveScene):
    ...
    def construct(self):
        ...
        self.play(self.frame.animate.reorient(0, 0, 0, (0.31, -0.02, 0.0), 1.49), a[0][2].animate.set_opacity(1.0), v1n.animate.set_opacity(1.0), a2[0][-1].animate.set_opacity(1.0), a2[1][11:13].animate.set_opacity(1.0), run_time=2.0)
        self.wait()
        full_panel = Group(a[0][1], a[0][2], a[1][1:11], a[0][0], a[0][3:], a2[0][3:], a2[1][7:13], a[1][17], a2[1][16], blue_word, a2[1][1][-2:], kt, q1n, k1n, v1n, x[0], x1n, x2n)
        full_panel.rotate([PI / 2, 0, 0], axis=RIGHT)
        self.frame.reorient(0, 90, 0, (-0.02, -0.02, -0.05), 2.03)
        self.wait()
        self.play(full_panel[2:].animate.set_opacity(0), self.frame.animate.reorient(0, 89, 0, (-0.18, -0.02, -0.25), 1.55), run_time=2)
        self.wait()
        self.play(full_panel[0].animate.move_to([-0.2, -0.01976856, -0.1]), full_panel[1].animate.move_to([-0.2, -0.01976856, -0.37]), run_time=1)
        self.wait()
