...
class p31c(InteractiveScene):
    ...
    def construct(self):
        ...
        for i in range(11, 0, -1):
            ...
            self.add(attention_heads[i][0][1].set_opacity(0.8))
        ...
        self.add(attention_heads[0][0][0].set_opacity(0.8))
        self.add(attention_heads[0][0][1].set_opacity(0.8))
        self.add(attention_heads[0][0][2].set_opacity(0.8))
