...
class p65_68_v2(InteractiveScene):
    ...
    def construct(self):
        ...
        x_train, y_train = (x_large[:15], y_large[:15])
        ...
        self.wait()
        self.play(LaggedStart(*[FadeIn(dot) for dot in sorted_dots_large], lag_ratio=0.05), run_time=4)
        self.play(ReplacementTransform(bias_error_line_1, bias_error_line_1_new), ReplacementTransform(variance_error_line_1, variance_error_line_1_new), ReplacementTransform(irreducible_error_line_1, irreducible_error_line_1_new), run_time=4)
        self.wait()
        ...
        self.play(FadeOut(train_dots_large), FadeOut(test_dots_large), ReplacementTransform(bias_error_line_1_new, bias_error_line_1_original), ReplacementTransform(variance_error_line_1_new, variance_error_line_1_original), ReplacementTransform(irreducible_error_line_1_new, irreducible_error_line_1_original), run_time=3)
        self.wait()
        self.play(FadeIn(interp_threshold_line), Write(interp_threshold_label))
        self.wait()
        random_seed = 428
        ...
        self.wait()
        self.play(FadeOut(train_dots), FadeOut(test_dots), fit_line_4.animate.set_stroke(opacity=0.2))
        random_seed = 328
        n_points = 10
        noise_level = 0.2
        all_x = np.linspace(-2, 2, 128)
        ...
        self.wait()
        self.play(FadeOut(train_dots), FadeOut(test_dots), fit_line_4b.animate.set_stroke(opacity=0.2))
        random_seed = 228
        n_points = 10
        noise_level = 0.2
        all_x = np.linspace(-2, 2, 128)
        ...
        self.play(*[ReplacementTransform(all_fourth_order_fits[i], mean_fit_line_4) for i in range(len(all_fourth_order_fits))], FadeIn(std_region_4), FadeOut(train_dots), FadeOut(test_dots), FadeOut(fit_line_4c), FadeOut(fit_line_4b), FadeOut(fit_line_4), run_time=5)
        ...
        self.play(FadeOut(std_region_4), FadeOut(mean_fit_line_4), ShowCreation(bias_error_line_4), ShowCreation(variance_error_line_4), ShowCreation(irreducible_error_line_4))
        ...
        self.wait()
        self.play(LaggedStart(*[ShowCreation(selected_fifth_order_fits[i]) for i in range(len(selected_fifth_order_fits))], lag_ratio=0.2), ShowCreation(bias_error_line_5), ShowCreation(variance_error_line_5), ShowCreation(irreducible_error_line_5), run_time=4)
        self.remove(test_error_dots)
        self.add(test_error_dots)
        self.wait()
        self.play(FadeOut(selected_fifth_order_fits))
        self.wait()
        self.play(self.frame.animate.reorient(0, 0, 0, (5.42, 0.77, 0.0), 8.36), FadeOut(parabola_copy), FadeOut(curve_fit_axis_svg), run_time=2)
        self.wait()
        self.wait(20)
        self.embed()