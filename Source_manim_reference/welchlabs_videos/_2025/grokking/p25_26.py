...
class P25_26(InteractiveScene):
    ...
    def construct(self):
        ...
        all_svgs = Group()
        for svg_file in svg_files[1:16]:
        ...
        self.wait()
        self.play(self.frame.animate.reorient(0, 0, 0, (-1.05, -0.07, 0.0), 6.12), *[Write(all_svgs[i]) for i in [1, 2]], lag_ratio=0.5, run_time=5)
        self.wait()
        example_index = 115
        ...
        self.wait()
        self.play(Write(all_svgs[0][7:14]), Write(all_svgs[0][15:]), self.frame.animate.reorient(0, 0, 0, (0.02, -0.06, 0.0), 7.58), run_time=2)
        self.wait()
