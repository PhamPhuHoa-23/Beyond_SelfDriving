...
class p7a(InteractiveScene):
    ...
    def construct(self):
        ...
        self.wait()
        self.frame.reorient(-4, 60, 0, (2.47, 0.04, -0.01), 8.0)
        ...
        self.wait()
        self.play(*[ReplacementTransform(og_line_copies[j], shifted_line_copies[j]) for j in range(len(shifted_line_copies))] + [ReplacementTransform(surfaces_1_copy[i], surfaces[2][0]) for i in range(len(surfaces[1]))], run_time=2)
        self.remove(shifted_line_copies)
        self.add(polygons_21)
        self.wait()
        shifted_line_copies_2.shift([3, 0, -0.7])
        self.add(og_line_copies_2)
        self.wait()
        self.play(*[ReplacementTransform(og_line_copies_2[j], shifted_line_copies_2[j]) for j in range(len(shifted_line_copies_2))] + [ReplacementTransform(surfaces_1_copy_2[i], surfaces[2][1]) for i in range(len(surfaces[1]))], self.frame.animate.reorient(-3, 61, 0, (2.87, 0.24, 0.08), 7.01), run_time=2)
        self.remove(shifted_line_copies_2)
        ...
        self.wait()
        self.play(surfaces[2][0].animate.shift([0, 0, -0.6]), surfaces[2][1].animate.shift([0, 0, 0.6]), polygons_21.animate.shift([0, 0, -0.6]).set_color(BLUE), polygons_22.animate.shift([0, 0, 0.6]).set_color(YELLOW), surfaces[1].animate.set_opacity(0.1), og_lines.animate.set_opacity(0.2), self.frame.animate.reorient(1, 42, 0, (3.0, 0.05, -0.17), 3.54), run_time=3)
        ...
        self.wait()
        self.play(ReplacementTransform(lines.copy(), lines_flat), ReplacementTransform(surfaces[2][0], flat_map), surfaces[1].animate.set_opacity(0.0), og_lines.animate.set_opacity(0.0), self.frame.animate.reorient(0, 45, 0, (4.28, 0.08, -0.19), 3.97), run_time=3)
        self.add(lines_flat)
        self.wait()
        self.wait(20)
        self.embed()
