...
class P39_47(InteractiveScene):
    ...
    def construct(self):
        ...
        for i in range(num_steps, len(trajectory)):
            ...
            self.wait(0.1)
        self.wait()
        self.play(self.frame.animate.reorient(104, 11, 0, (-0.09, -0.35, -0.06), 2.6), run_time=4)
        self.wait()
        self.play(s1.animate.set_opacity(0.0), dot_path.animate.set_opacity(0.0), self.frame.animate.reorient(142, 34, 0, (-0.09, -0.77, 0.15), 3.55), run_time=4.0)
        self.remove(s1)
