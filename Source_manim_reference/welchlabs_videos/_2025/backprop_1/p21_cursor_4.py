...
def get_scatter_points(t, initial_bounds, final_bounds, x_axis_position, y_axis_position):
    ...
    for x_val, y_val in zip(x_values, y_values):
        ...
        dot = Dot(point=[x_pos, y_pos, 0], radius=0.06, stroke_width=0, fill_opacity=0.8)
...
class P21_bigger_dots(InteractiveScene):
    ...
    def construct(self):
        ...
        losses_scatter = always_redraw(lambda: get_losses_scatter_points(t_tracker.get_value(), initial_x_range, final_x_range, x_axis_position, y_axis_position, y_zoom_tracker.get_value()))
        losses_scatter_2 = get_losses_scatter_points(1.0, initial_x_range, final_x_range, x_axis_position, y_axis_position, 1.0)
