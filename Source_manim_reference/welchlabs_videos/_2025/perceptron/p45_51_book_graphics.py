    ...
    def construct(self):
        ...
        for w0 in w0_range:
            for w1 in w1_range:
                ...
                point_count += 1
        self.wait()
        self.frame.reorient(47, 45, 0, (0.02, 0.18, 1.36), 8.0)
        self.wait()
        self.frame.reorient(52, 66, 0, (-0.04, 0.33, 1.73), 7.1)
        self.wait()
        self.frame.reorient(27, 47, 0, (0.0, -0.07, 1.54), 7.1)
        self.wait()
        self.frame.reorient(68, 61, 0, (-0.11, -0.21, 1.62), 7.09)
        self.wait()
        self.frame.reorient(90, 0, 0, (0.0, 0.0, 0.0), 8.6)
        self.wait()
