...
class p46_sketch(InteractiveScene):
    ...
    def construct(self):
        ...
        nums[0].set_opacity(1.0)
        nums[7].set_opacity(1.0)
        self.wait()
        self.play(line_1.animate.set_opacity(1.0), line_2.animate.set_opacity(1.0), line_3.animate.set_opacity(1.0), arrow_tip_1.animate.set_opacity(1.0), arrow_tip_2.animate.set_opacity(1.0), arrow_tip_3.animate.set_opacity(1.0), run_time=1.0)
        self.remove(arrow_tip_2)
        self.add(arrow_tip_2)
        self.wait()
        ...
        self.play(overlays_1[1:].animate.set_opacity(0.0))
        ...
        europe_map.move_to([-1, 0.23, 0])
        self.frame.reorient(-30, 59, 0, (-1.02, 0.04, -0.0), 0.62)
        ...
        self.wait()
        self.play(Transform(matching_plane_1, matching_surface_1), ReplacementTransform(line_1, softmax_curve_1), Transform(matching_plane_2, matching_surface_2), ReplacementTransform(line_2, softmax_curve_2), Transform(matching_plane_3, matching_surface_3), ReplacementTransform(line_3, softmax_curve_3), run_time=3)
        self.wait()
        self.wait()
        self.embed()
        self.wait()
