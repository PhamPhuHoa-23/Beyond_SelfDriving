    ...
    def construct(self):
        ...
        def create_multi_snapshot_animation(self, all_forward_passes, all_backward_passes, individual_time=1.0, lag_ratio=0.5, start_opacity=0.0, end_opacity=1.0, fade_out_time=1.0, pause_between_snapshots=0.5):
            ...
            for i, (forward, backward) in enumerate(zip(all_forward_passes, all_backward_passes)):
                ...
                if objects:
                    snapshot_data.append({'objects': objects, 'start_time': total_time, 'animation_time': anim_time, 'updater_func': updater_func})
        ...
        time_tracker, total_time = create_multi_snapshot_animation(self, all_forward_passes, all_backward_passes, individual_time=1.0, lag_ratio=0.5, start_opacity=0.0, end_opacity=1.0, fade_out_time=1.0, pause_between_snapshots=0.5)
        self.wait()
