...
class LlamaLearningSketchThree(InteractiveScene):
    ...
    def construct(self):
        ...
        self.wait()
        time_tracker, actual_total_time, objects = create_lag_animation(list(forward_pass) + list(backward_pass[::-1]), individual_time=1.5, lag_ratio=0.2, start_opacity=0.0, end_opacity=1.0)
        self.wait()
        ...
        forward_pass.set_opacity(0.0)
        self.wait()
        self.play(forward_pass.animate.set_opacity(0.0), backward_pass.animate.set_opacity(0.0), run_time=2.0)
        self.play(time_tracker.animate.set_value(actual_total_time), run_time=actual_total_time)
        self.wait()
        self.wait()
        self.wait()
