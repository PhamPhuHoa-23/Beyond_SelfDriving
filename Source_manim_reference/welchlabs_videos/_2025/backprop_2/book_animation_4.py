...
class LinearPlane(Surface):
    ...
    def __init__(self, axes, m1=0.5, m2=0.3, b=1.0, vertical_viz_scale=0.5, **kwargs):
        ...
        super().__init__(u_range=(-6, 11), v_range=(-8, 4), resolution=(256, 256), color=BLUE, **kwargs)
...
class p48_49_v2(InteractiveScene):
    ...
    def construct(self):
        ...
        for i in range(249, 250):
            ...
            if ys[i] == 0.0:
                training_point.set_color(BLUE)
            elif ys[i] == 1.0:
                training_point.set_color(RED)
            elif ys[i] == 2.0:
                training_point.set_color(GREEN)
            elif ys[i] == 3.0:
                training_point.set_color(PURPLE)
        ...
        vert_offset = 2.5
        self.play(ap1.animate.scale(4.5).move_to([0, 0, vert_offset]).set_opacity(0.4), ap2.animate.scale(4.5).move_to([0, 0, vert_offset]).set_opacity(0.4), ap3.animate.scale(4.5).move_to([0, 0, vert_offset]).set_opacity(0.4), ap4.animate.scale(4.5).move_to([0, 0, vert_offset]).set_opacity(0.4), europe_map.animate.rotate(-90 * DEGREES, [1, 0, 0]).move_to([-0.05, -0.05, vert_offset]), self.frame.animate.reorient(-35, 47, 0, (-0.14, -0.14, -0.18), 1.44), run_time=7.0)
        self.wait()
