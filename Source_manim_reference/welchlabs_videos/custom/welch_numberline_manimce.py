...
class WelchNumberLineExample(Scene):
    ...
    def construct(self):
        ...
        welch_number_line2 = WelchNumberLine(stroke_width=5, x_range=[-2, 3, 1], include_tip=True).scale(1.23)
        welch_number_line2.remove_tip('start')
        welch_number_line3 = WelchNumberLine(stroke_width=5, x_range=[-3, 12, 1], include_tip=True)
