...
spectra_keys_1 = ['', 'mc_sent1_tell_T', 'mc_sent1_tell_AH', 'mc_sent1_tell_EL', 'mc_sent1_me_M', 'mc_sent1_me_IY', 'mc_sent1_us_IH', 'mc_sent1_us_S', 'mc_sent1_all_OW', 'mc_sent1_all_EL', 'mc_sent1_about_A', 'mc_sent1_about_B', 'mc_sent1_about_AW', 'mc_sent1_about_T', 'mc_sent1_china_SH', 'mc_sent1_china_AY', 'mc_sent1_china_N', 'mc_sent1_china_UH', 'mc_sent1_nixon_N', 'mc_sent1_nixon_IH', 'mc_sent1_nixon_X', 'mc_sent1_nixon_EN', 'mc_sent2_give_G', 'mc_sent2_give_IH', 'mc_sent2_give_V', 'mc_sent2_me_M', 'mc_sent2_me_IY', 'mc_sent2_the_TH', 'mc_sent2_the_UH', 'mc_sent2_the_UH', 'mc_sent2_headlines_H', 'mc_sent2_headlines_AA', 'mc_sent2_headlines_D', 'mc_sent2_headlines_L', 'mc_sent2_headlines_AY', 'mc_sent2_headlines_N', 'mc_sent2_headlines_S', 'mc_sent2_news_N', 'mc_sent2_news_OO', 'mc_sent2_news_S', '']
...
spectra_keys_2 = ['stephen_tell_T', 'stephen_tell_EL', 'stephen_me_M', 'stephen_me_IY', 'stephen_about_A', 'stephen_about_B', 'stephen_about_AW', 'stephen_about_T', 'stephen_china_SH', 'stephen_china_AY', 'stephen_china_N', 'stephen_china_UH']
    ...
    def construct(self):
        ...
        for spectra_key, (label, idx, x, y) in zip(spectra_keys_1, nodes):
            ...
            if spectra_key == '':
                ...
                axes = Axes(x_range=[0, 25000, 5000], y_range=[0, 1, 0.5], width=0.9, height=0.6, axis_config={'color': CHILL_BROWN, 'stroke_width': 3.0, 'include_ticks': False, 'include_tip': True, 'tip_config': {'width': 0.01, 'length': 0.01}})
                ...
                text.set_color(CHILL_BROWN)
                text.scale(0.8)
                box = RoundedRectangle(width=axes.get_width() + 2 * buff, height=axes.get_height() + 2 * buff, corner_radius=0.15, color=CHILL_BROWN)
                box.set_stroke(width=2)
        ...
        graph_2.center()
        self.wait()
        self.play(ReplacementTransform(graph, graph_2), self.frame.animate.reorient(0, 0, 0, (0.18, 0.5, 0.0), 18.15), run_time=5)
        self.wait()
        self.play(self.frame.animate.reorient(0, 0, 0, (-7.31, 0.11, 0.0), 9.9), run_time=5)
        self.wait(0)
        self.play(self.frame.animate.reorient(0, 0, 0, (-0.08, 2.77, 0.0), 17.74), run_time=5)
        self.wait()
        axes_width = 22
        ...
        for count, phone_key in enumerate(spectra_keys_2):
            axes_2 = Axes(x_range=[0, 25000, 5000], y_range=[0, 1, 0.5], width=1.9, height=1.3, axis_config={'color': CHILL_BROWN, 'stroke_width': 4.0, 'include_ticks': False, 'include_tip': True, 'tip_config': {'width': 0.01, 'length': 0.01}})
        ...
        self.wait()
        self.play(spectra_curve_copy.animate.move_to(all_nodes_2[1].get_center()).scale(0.5), spectra_curve_copy_2.animate.move_to(all_nodes_2[22].get_center()).scale(0.5), self.frame.animate.reorient(0, 0, 0, (-9.17, 0.08, 0.0), 7.06), run_time=7)
        self.wait()
        ...
        self.wait()
        self.play(self.frame.animate.reorient(0, 0, 0, (-8.74, 3.66, 0.0), 7.59), run_time=5)
        self.wait()
        spectra_curve_copy = spectra_plots[1][1].copy()
        spectra_curve_copy_2 = spectra_plots[1][1].copy()
        self.play(spectra_curve_copy.animate.move_to(all_nodes_2[2].get_center()).scale(0.5), spectra_curve_copy_2.animate.move_to(all_nodes_2[3].get_center()).scale(0.5), run_time=5)
        self.wait()
        ...
        self.play(spectra_curve_copy.animate.move_to(all_nodes_2[4].get_center()).scale(0.5), spectra_curve_copy_2.animate.move_to(all_nodes_2[6].get_center()).scale(0.5), run_time=5)
        self.wait()
        graph_2[0][4].set_color(MAGENTA)
        graph_2[1][4][2].set_color(MAGENTA)
        graph_2[1][4][3].set_color(MAGENTA)
        self.wait()
        graph_2[0][6].set_color(MAGENTA)
        graph_2[1][5][2].set_color(MAGENTA)
        graph_2[1][5][3].set_color(MAGENTA)
        self.wait()
        self.play(self.frame.animate.reorient(0, 0, 0, (-0.02, 3.14, 0.0), 17.59), run_time=4)
        spectra_curve_copy = spectra_plots[4][1].copy()
        spectra_curve_copy_2 = spectra_plots[4][1].copy()
        self.play(spectra_curve_copy.animate.move_to(all_nodes_2[8].get_center()).scale(0.5), spectra_curve_copy_2.animate.move_to(all_nodes_2[10].get_center()).scale(0.5), run_time=5)
        self.wait()
        graph_2[0][9].set_color(MAGENTA)
        graph_2[1][10][2].set_color(MAGENTA)
        graph_2[1][10][3].set_color(MAGENTA)
        self.wait()
        graph_2[0][14].set_color(MAGENTA)
        graph_2[1][11][2].set_color(MAGENTA)
        graph_2[1][11][3].set_color(MAGENTA)
        self.wait()
        graph_2[0][15].set_color(MAGENTA)
        graph_2[1][12][2].set_color(MAGENTA)
        graph_2[1][12][3].set_color(MAGENTA)
        self.wait()
        graph_2[0][16].set_color(MAGENTA)
        ...
        self.play(spectra_curve_copy.animate.move_to(all_nodes_2[14].get_center()).scale(0.5), spectra_curve_copy_2.animate.move_to(all_nodes_2[18].get_center()).scale(0.5), run_time=5)
        self.wait()
        graph_2[0][17].set_color(MAGENTA)
        graph_2[1][14][2].set_color(MAGENTA)
        graph_2[1][14][3].set_color(MAGENTA)
        self.wait()
        graph_2[0][18].set_color(MAGENTA)
        graph_2[1][15][2].set_color(MAGENTA)
        graph_2[1][15][3].set_color(MAGENTA)
        self.wait()
        graph_2[0][19].set_color(MAGENTA)
        graph_2[1][16][2].set_color(MAGENTA)
        graph_2[1][16][3].set_color(MAGENTA)
        self.wait()
        graph_2[0][20].set_color(MAGENTA)
        graph_2[1][17][2].set_color(MAGENTA)
        graph_2[1][17][3].set_color(MAGENTA)
        self.wait()
        graph_2[0][25].set_color(MAGENTA)
