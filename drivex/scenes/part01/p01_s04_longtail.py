...
class P01S04LongTail(Scene):
    ...
    def construct(self):
        ...
        photos = VGroup(
            ...
            _photo_placeholder("Traffic lights\non truck\n(traffic_truck.png)"),
        ...
        curve = axes.plot(dist_func, x_range=[0.01, 5.0], color=COL_BLUE, stroke_width=2.5)
        ...
        x_label_common = Text("Common situations", font_size=13, color=COL_LIGHT_BLUE)
        ...
        # "Common Sense" flash
        cs_text = Text("→ Common Sense", font_size=28, color=COL_GOLD, weight=BOLD)
