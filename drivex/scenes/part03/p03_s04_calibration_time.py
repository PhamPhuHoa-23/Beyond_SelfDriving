...
class P03S04CalibrationTime(Scene):
    ...
    def construct(self):
        ...
        heading = Text("Time Calibration", font_size=28, color=COL_GOLD, weight=BOLD)
        ...
        sol_title = Text("Solution", font_size=18, color=COL_GREEN, weight=BOLD)
        ...
        gps_lbl = Text("GPS Shared Time Source", font_size=13, color=COL_WHITE, weight=BOLD)
        ...
        hw_lbl  = Text("Hardware Trigger", font_size=13, color=BG_BLACK, weight=BOLD)
        ...
        sw_lbl  = Text("Software Trigger", font_size=13, color=COL_WHITE, weight=BOLD)
        ...
        latency_sw = Text("OS jitter: ±100 ms", font_size=11, color=COL_RED, slant=ITALIC)
        latency_sw.next_to(sw_box, DOWN, buff=0.15)
        latency_hw = Text("Precision: < 1 µs", font_size=11, color=COL_GREEN, slant=ITALIC)
        ...
        self.play(FadeIn(VGroup(hw_box, hw_lbl)), FadeIn(VGroup(sw_box, sw_lbl)), run_time=0.3)
