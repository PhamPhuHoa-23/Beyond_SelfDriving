...
class P03S07LocalizationWhy(Scene):
    ...
    def construct(self):
        ...
        heading = Text("Mapping & Localization", font_size=26,
        ...
        fail_title = Text("Without accurate localization:",
        ...
        ped_real = Circle(radius=0.22, fill_color=COL_WHITE,
                          fill_opacity=1, stroke_width=0)
        ped_real.move_to(LEFT * 1.5 + DOWN * 0.2)
        ped_ghost = Circle(radius=0.22, fill_color=COL_WHITE,
                           fill_opacity=0.5, stroke_width=0)
        ped_ghost.move_to(RIGHT * 1.5 + DOWN * 0.2)

        lbl_r = Text("Agent A sees pedestrian here",
