...
class P03S06DataCollection(Scene):
    ...
    def construct(self):
        ...
        heading = Text("Data Collection Strategy", font_size=26,
        ...
        self.play(Create(right_turn), Create(left_turn),
                  Create(straight), run_time=0.7)
        ...
        time_strip = VGroup(*band_grps).arrange(RIGHT,
                                                buff=0).move_to(DOWN * 2.4)
