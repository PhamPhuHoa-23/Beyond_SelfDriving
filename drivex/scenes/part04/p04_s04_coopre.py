...
class P04S04CooPre(Scene):
    ...
    def construct(self):
        ...
        badge_txt = Text("Zero annotations", font_size=12, color=COL_GREEN, weight=BOLD)
        ...
        self.play(FadeIn(ag1), FadeIn(ag2), FadeIn(ag1_lbl), FadeIn(ag2_lbl), run_time=0.4)
        ...
        for idx in mask_indices:
            ...
            filled_cells.add(f)
        self.play(Transform(masked_cells, filled_cells), run_time=0.6, rate_func=smooth)
        ...
        res_title = Text("CooPre Results", font_size=20, color=COL_GOLD, weight=BOLD)
        ...
        for i, (lbl, h, col) in enumerate(bar_data):
            ...
            self.play(Transform(start, bar), FadeIn(b_lbl), run_time=0.45, rate_func=smooth)
        ...
        paper = Text("CooPre  ·  IROS 2025", font_size=11, color=COL_WHITE, slant=ITALIC)
