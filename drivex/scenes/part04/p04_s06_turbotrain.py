...
class P04S06TurboTrain(Scene):
    ...
    def construct(self):
        ...
        badge1 = solves_badge("initialization sensitivity", COL_GREEN, stage1, DOWN)
        badge2 = solves_badge("gradient conflict",          COL_GREEN, stage2, DOWN)
        ...
        axes = Axes(
            ...
            axis_config={"color": COL_WHITE, "stroke_width": 1.5, "include_numbers": False},
            tips=False,
        ).shift(DOWN * 0.5)
        ...
        star_lbl = Text("TurboTrain\n~45 epochs", font_size=12, color=COL_GOLD, weight=BOLD)
