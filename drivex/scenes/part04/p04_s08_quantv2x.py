...
class P04S08QuantV2X(Scene):
    ...
    def construct(self):
        ...
        agent_lbl = Text("Agent\n(NN)", font_size=13, color=COL_BLUE, weight=BOLD)
        ...
        l1_txt = Text("Layer 1: FP32 → INT8", font_size=12, color=INT8_GREEN, weight=BOLD)
        ...
        l2_box = RoundedRectangle(width=2.4, height=0.7, corner_radius=0.12,
                                   ...
                                   stroke_color=INT8_GREEN, stroke_width=1.8)
        l2_txt = Text("Layer 2: Codebook (300×)", font_size=12, color=INT8_GREEN, weight=BOLD)
        ...
        brace_txt = Text("300× smaller", font_size=13, color=COL_GOLD, weight=BOLD)
        ...
        self.play(GrowArrow(a_to_l1), FadeIn(VGroup(l1_box, l1_txt)), run_time=0.4)
        ...
        self.play(Transform(bev_big, bev_small.copy().set_fill(INT8_GREEN)), run_time=0.8)
