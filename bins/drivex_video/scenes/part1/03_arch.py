...
class AVArchitectures(Scene):
    def construct(self):
        title = Text("Three Pillars of AV Architecture", font="Latin Modern Roman", font_size=42, weight=BOLD)
        ...
        labels = Group(
            Text("Modular", font="Latin Modern Roman", font_size=22, color=UCLA_GOLD, weight=BOLD),
            Text("End-to-End", font="Latin Modern Roman", font_size=22, color=UCLA_GOLD, weight=BOLD),
            Text("Hybrid", font="Latin Modern Roman", font_size=22, color=UCLA_GOLD, weight=BOLD)
        )
        ...
        lab_mod = Text("Current Standard", font="Latin Modern Roman", font_size=22, color=BLUE_A).next_to(box_mod, UP)
        self.play(Create(box_mod), FadeIn(lab_mod))
        self.play(Indicate(box_mod, color=BLUE_A))
        self.wait(1.5)
        
        lab_e2e = Text("Future Generalization", font="Latin Modern Roman", font_size=22, color=DRIVEX_ACCENT).next_to(box_e2e, UP)
